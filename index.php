...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300&family=Oswald:wght@200;300;400;500;600;700&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <footer class="rodape">
        COD3R & ALLAN - &copy; Copyright <?= date('Y');?>
    </footer>
</body>
